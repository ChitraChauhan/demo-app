	...
	render() {
		...
		const formInstance = (
			<form onSubmit={this.handleFormSubmit}>
				...
				<FieldGroup id="formname" label="FullName" type="text"
					name="name"
					placeholder="Enter first name and last name"
					onChange={(e) => onChange(e)}
					required="true" />
				<FieldGroup id="formFixedPhone" label="Fixed Phone" type="text"
					name="fixedPhone"
					placeholder="Fixed Phone"
					onChange={(e) => onChange(e)}/>
				<FieldGroup id="formFax" label="Fax" type="text"
					name="fax"
					placeholder="Fax"
					onChange={(e) => onChange(e)}/>
				<FieldGroup id="formEmail" label="Email Address" type="email"
					placeholder="Enter email" 
					name="emailAddress"
					onChange={(e) => onChange(e)}/> 
				<FieldGroup id="formControlsTextarea" label="Notes" componentClass="textarea" 
